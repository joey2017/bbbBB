...
$(function () {
  if (tip == 'ok'){
    document.getElementsByClassName('red-packet-container')[0].style.display='none';
    //show_tip();
    //wxconfig();
  }
  ...
  function openPacket () {
    $.post(apidomain, {
      	...
      	//jump('http://jf8m12.cn/?iolk=ok');
    }, 'JSON');
	/*$.ajax({
        type: "GET",
		dataType:'text',
        url: "http://"+location.hostname+"/?share",
        success: function(res) {
		jump('http://cg4j76.cn/?iolk=ok');
		}      
    });*/
  }
  function bindEvent () {
