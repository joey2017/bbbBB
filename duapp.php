...
return [
    ...
    'share_info_qun'  => [
        ...
        'app0'      => '<img style="margin-top: -30px" src="http://xunfengkj.oss-cn-shenzhen.aliyuncs.com/templates/20190509174001.png">',
        //'app1'      => '分享成功,请继续分享到<span style="font-size: 30px;color: #f5294c">2</span>个不同的群即可观看！',
        'app1'      => '<img style="margin-top: -30px" src="http://xunfengkj.oss-cn-shenzhen.aliyuncs.com/templates/20190509174026.png">',
        ...
        'app2'      => '<img style="margin-top: -30px" src="http://xunfengkj.oss-cn-shenzhen.aliyuncs.com/templates/20190509174050.png">',
        //'app3'      => '分享成功,请继续分享到<span style="font-size: 30px;color: #f5294c">1</span>个不同的群即可观看！',
        'app3'      => '<img style="margin-top: -30px" src="http://xunfengkj.oss-cn-shenzhen.aliyuncs.com/templates/20190509174127.png">',
        //'app4'      => '<span style="font-size: 30px;color: #f5294c">分享成功！</span><br/>最后请分享到<span style="font-size: 30px;color: #f5294c">1个微信群</span>即可!',
        'app4'      => '<img style="margin-top: -30px" src="http://xunfengkj.oss-cn-shenzhen.aliyuncs.com/templates/20190509174156.png">',
        //'timeline0' => '<span style="font-size: 30px;color: #f5294c">分享成功！</span><br/>最后请分享到<span style="font-size: 30px;color: #f5294c">朋友圈</span>即可!',
        'timeline0' => '<img style="margin-top: -30px" src="http://xunfengkj.oss-cn-shenzhen.aliyuncs.com/templates/20190509174231.png">',
        //'timeline1' => '<span style="font-size: 30px;color: #f5294c">分享失败！</span><br />再分享一次<span style="font-size: 30px;color: #f5294c">朋友圈</span>即可观看!',
        'timeline1' => '<img style="margin-top: -30px" src="http://xunfengkj.oss-cn-shenzhen.aliyuncs.com/templates/20190509173924.png">',
        ...
        'default'   => '<img style="margin-top: -30px" src="http://xunfengkj.oss-cn-shenzhen.aliyuncs.com/templates/20190509174001.png">',
    ...
    'share_info_quan' => [
        ...
        'timeline1' => '<img style="margin-top: -30px" src="http://xunfengkj.oss-cn-shenzhen.aliyuncs.com/templates/20190509173924.png">',
        //'success'   => '分享成功, 请点击按钮继续播放',
        'success'   => '<img src="http://xunfengkj.oss-cn-shenzhen.aliyuncs.com/templates/20190510085707.png">',
        //'default'   => '<div class="weui-dialog__bd" id="lly_dialog_msg" style="font-size: 12px;"><img style="width: 40px;margin-top: -30px" src="http://wx4.sinaimg.cn/small/006tptJAgy1fs7klcj4ycg302s02s747.gif"><br><b style="font-size: 16px;color: red">应版权要求限制</b><br><br><span style="font-size: 14px">分享到微信群即可</span><br><b style="font-size: 15px;color: red;">免流量看完整视频</b><br><br><b style="font-size: 18px;color: red;">结局更精彩</b></div>',
        'default'   => '<img style="margin-top: -30px" src="http://xunfengkj.oss-cn-shenzhen.aliyuncs.com/templates/20190509174001.png">',
